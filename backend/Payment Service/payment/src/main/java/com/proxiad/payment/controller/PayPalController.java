...
public class PayPalController {
    ...
    @PostMapping
    public ResponseEntity<PaymentResponse> createOrder(@Valid @RequestBody CreatePaymentRequest request) {
        log.info("Creating PayPal order for orderId: {}, customerId: {}", request.getOrderId(), request.getCustomerId());
