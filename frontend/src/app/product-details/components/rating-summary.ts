...
@Component({
  ...
  imports: [StarRating, DecimalPipe],
  template: `
    <div class="flex items-center gap-8 mb-6 p-4 bg-gray-50 rounded-lg">
      <div class="flex flex-col items-center w-1/3 md:w-1/2">
        ...
        <div class="text-sm text-gray-500">Based on {{ reviewCount() }} reviews</div>
      </div>
      <div class="flex-1">
          ...
          <div class="flex items-center gap-2 mb-2">
            ...
            <div class="flex-1 bg-gray-200 rounded-full h-2 mx-2">
              <div
                ...
                [style.width.%]="reviewBreakdown.percentage"
              ></div>
            </div>
